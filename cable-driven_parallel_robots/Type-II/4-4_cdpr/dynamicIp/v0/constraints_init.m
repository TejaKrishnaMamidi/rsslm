% RSSLM-CDPR-Type-II-DynamicIp constraints_init module. The variables that do not change with respect to a configuration variable while computing the values of constraint functions and their derivatives are initialised here.
...
global nus5 alp a bt r dx dy dz q dq;

% Global variables -- defined/modified
global tt tb so st vt Qf p mpa mpv;
