...
% Removes any zero entries from the imported data.
zeroIndex = [];
...
%for i=1
    ...
    %
    % Exporting cable configurations - uncomment the below lines if the evolution of the shapes of cables are required.
...
%    fprintf(fidt,'\n');
    ...
    axis([ xmin+mpcom(1) xmax+mpcom(1)  ymin+mpcom(2) ymax+mpcom(2) zmin+mpcom(3) zmax+mpcom(3)]);
