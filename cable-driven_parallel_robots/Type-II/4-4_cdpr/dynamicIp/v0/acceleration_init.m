% RSSLM-CDPR-Type-II-DynamicIp acceleration_init module. The common portions in determining the changes in joint accelerations with perturbations in the joint positions and velocities are computed here.
...
function [phihat, ihatTr, ibar, psibar, psibarAux1, psibarAux2, auxa, auxa1, auxa2, auxa3, auxa4, auxb, auxb1, auxb2, auxb3, auxb4, auxc0, auxc, auxc1, auxc2, auxc3, auxc4, auxd01, auxd02, auxd, auxd1, auxd2, auxd3, auxd4, auxe01, auxe02, auxe03, auxe, auxe1, auxe2, auxe3, auxf01, auxf02, auxf03, auxf04, auxf, auxf1, auxf2, auxg01, auxg02, auxg03, auxg04, auxg, auxg1, auxh01, auxh02, auxh03, auxh04, auxh, auxp1, auxp2, auxp3, auxp4, auxp5, auxp6, auxp7] = acceleration_init(q, dq, tu, tau_d)
...
ibar = zeros(24,24);
psibarAux1 = zeros(24,1);
psibarAux2 = zeros(24,1);
...
% Since the inverse of the GIM of the first to fourth sub-systems are not explicitly computed, the nullity of J(ii, nlsi+3:nusi) was not exploited while computing ihatTr(nlsi:nusi, ii), i=1,...,4, and ii=13,...,24. A possible optimisation is to find invMi(nlsi:nlsi+2, nlsi:nlsi+2) by any other method.
...
psibarAux1(13:15) = -J(13:15,nls1:nls1+2)*phihat(nls1:nls1+2)-J(13:15,nls6:nls6+2)*phihat(nls6:nls6+2);
psibarAux1(16:18) = -J(16:18,nls2:nls2+2)*phihat(nls2:nls2+2)-J(16:18,nls7:nls7+2)*phihat(nls7:nls7+2);
psibarAux1(19:21) = -J(19:21,nls3:nls3+2)*phihat(nls3:nls3+2)-J(19:21,nls8:nls8+2)*phihat(nls8:nls8+2); 
psibarAux1(22:24) = -J(22:24,nls4:nls4+2)*phihat(nls4:nls4+2)-J(22:24,nls9:nls9+2)*phihat(nls9:nls9+2);
