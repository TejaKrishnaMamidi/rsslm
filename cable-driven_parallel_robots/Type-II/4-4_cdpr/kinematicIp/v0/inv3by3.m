% RSSLM-CDPR-Type-II-KinematicIp (or Type-I or Kinetostatics) inv3by3 module. A pre-computed symbolic expressions of the inverse of a non-singular matrix of dimension 3 by 3 is used for determining the matrix inverse.
...
if abs(detA)>1e-15
    ...
    disp('Warning::inv3by3:The input matrix is badly conditioned.');
    inva = pinv(matA);
end
