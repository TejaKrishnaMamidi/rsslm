% RSSLM-CDPR-Type-II-KinematicIp (or Type-I or Kinetostatics) jacobian module. This code decides when to update the constraint Jacobain matrix and it's derivative.
