% RSSLM-CDPR-Type-II-KinematicIp acceleration_var module. The varying portions in determining the changes in joint accelerations with perturbations in the joint positions and velocities are computed here. 
...
function [qdd] = acceleration_var(jj, fl, q, dq, tu, tau_d, phihat, ihatTr, ibar, psibar, psibarAux1, psibarAux2, psibarAux3, auxa, auxa1, auxa2, auxa3, auxa4, auxb, auxb1, auxb2, auxb3, auxb4, auxc0, auxc, auxc1, auxc2, auxc3, auxc4, auxd01, auxd02, auxd, auxd1, auxd2, auxd3, auxd4, auxe01, auxe02, auxe03, auxe, auxe1, auxe2, auxe3, auxf01, auxf02, auxf03, auxf04, auxf, auxf1, auxf2, auxg01, auxg02, auxg03, auxg04, auxg, auxg1, auxh01, auxh02, auxh03, auxh04, auxh, auxp1, auxp2, auxp3, auxp4, auxp5, auxp6, auxp7)

% Global variables -- required
global alp a b th r dx dy dz m Icxx Icyy Iczz Icxy Icyz Iczx J dJ ni;
global nls1 nls2 nls3 nls4 nls5 nus1 nus2 nus3 nus4 nus5 invmp n nc;
...
if fl == 0
    ...
    if jj<=nus1
        ...
        psibar(13:15) = -J(13:15,nls1:nls1+2)*phihat(nls1:nls1+2) + psibarAux3(13:15);
    ...
    elseif jj<=nus2
    	...
    	psibar(16:18) = -J(16:18,nls2:nls2+2)*phihat(nls2:nls2+2)+psibarAux3(16:18);
        % Computation of lambda
        auxb  = inv3by3(ibar(4:6,4:6)-auxa1*ibar(1:3,4:6));	
    	auxb1 = (ibar(7:9,4:6)-auxa2*ibar(1:3,4:6))*auxb;
    	auxb2 = (ibar(10:12,4:6)-auxa3*ibar(1:3,4:6))*auxb;
    ...
    elseif jj<=nus3
        ...
        psibar(19:21) = -J(19:21,nls3:nls3+2)*phihat(nls3:nls3+2) + psibarAux3(19:21);
    	% Computation of lambda
        auxc  = inv3by3(ibar(7:9,7:9)-auxa2*ibar(1:3,7:9)-auxb1*auxc0);
    	auxc1 = (ibar(10:12,7:9)-auxa3*ibar(1:3,7:9)-auxb2*auxc0)*auxc;
    	auxc2 = (-auxa4*ibar(1:3,7:9)-auxb3*auxc0)*auxc;
    ...
    elseif jj<=nus4
        ...
        psibar(22:24) = -J(22:24,nls4:nls4+2)*phihat(nls4:nls4+2) + psibarAux3(22:24);
        % Computation of lambda
        auxd = inv3by3(ibar(10:12,10:12)-auxa3*ibar(1:3,10:12)-auxb2*auxd01-auxc1*auxd02);
        auxd1 = (-auxa4*ibar(1:3,10:12)-auxb3*auxd01-auxc2*auxd02)*auxd;
        auxd2 = (-auxb4*auxd01-auxc3*auxd02)*auxd;
