% RSSLM-CDPR-Type-II-KinematicIp constraints module. The values of constraint functions and their derivatives are computed.
...
global alp a bt r nus1 nus2 nus3 nus4 nus5 mpa mpv;

% Computation of the values of the constraint functions
for ii=il:iu
	%p(ii)=1-r(ii);
