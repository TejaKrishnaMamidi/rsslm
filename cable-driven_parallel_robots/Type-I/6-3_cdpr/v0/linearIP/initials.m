...
% System: 6-3 CDPR with each cable modelled by multiple modified rigid finite elements and cable feed
...
% The previous time instance is initialised to be ti.
tp=ti;

% Initialising of rate of change of inertia, locations of the centres of mass (Modified later in inputs.m)
dmdt=zeros(n,1);
ddxdt=zeros(n,1);
ddydt=zeros(n,1);
ddzdt=zeros(n,1);
