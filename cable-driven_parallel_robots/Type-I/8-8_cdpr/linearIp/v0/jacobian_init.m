...
global qi dqi J dJ tt tb so Qf p;
...
for ii = nls7:nus7
    qi(ii)=qi(ii)+h;
    [eta1,deta1]=constraints(ii, nus7, qi, dqi, tt, tb, so, Qf, p, bc, thc);
    qi(ii)=qi(ii)-twoh;
    [eta2,deta2]=constraints(ii, nus7, qi, dqi, tt, tb, so, Qf, p, bc, thc);
    qi(ii)=qi(ii)+h;
    J(:,ii)=invh*(eta1-eta2);
    dJ(:,ii)=invh*(deta1-deta2);
end
...
for ii = nls8:nus8
    qi(ii)=qi(ii)+h;
    [eta1,deta1]=constraints(ii, nus8, qi, dqi, tt, tb, so, Qf, p, bc, thc);
    qi(ii)=qi(ii)-twoh;
    [eta2,deta2]=constraints(ii, nus8, qi, dqi, tt, tb, so, Qf, p, bc, thc);
    qi(ii)=qi(ii)+h;
    J(:,ii)=invh*(eta1-eta2);
    dJ(:,ii)=invh*(deta1-deta2);
end
