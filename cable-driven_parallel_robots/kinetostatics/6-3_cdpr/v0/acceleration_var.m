% RSSLM-CDPR-Kinetostatics acceleration_init module. The varying portions in determining the changes in joint accelerations with perturbations in the joint positions and velocities are computed here. 
...
function [qdd] = acceleration_var(jj, fl, q, dq, tu, tau_d, phihat, ihatTr, ibar, psibar, psibarAux1, psibarAux2, auxa, auxa1, auxa2, auxa3, auxa4, auxa5, auxb, auxb1, auxb2, auxb3, auxb4, auxc0, auxc, auxc1, auxc2, auxc3, auxd01, auxd02, auxd, auxd1, auxd2, auxe01, auxe02, auxe03, auxe, auxe1, auxf01, auxf02, auxf03, auxf04, auxp1, auxp2, auxp3, auxp4, auxp5)

% Global variables -- required
global alp a b th r dx dy dz m Icxx Icyy Iczz Icxy Icyz Iczx J dJ ni invmp;
% Limits for the sub-systems
global nls1 nls2 nls3 nls4 nls5 nls6 nls7 nus1 nus2 nus3 nus4 nus5 nus6 nus7 nls7p2 nls7p3;
...
% Generalised inertia matrix of seventh sub-system
...
if fl == 0
    ...
    if jj<=nus1
        ...
        % Psibar
        psibarAux1(1:3) = - J(1:3,nls1:nus1)*phihat(nls1:nus1)-J(1:3,nls7:nus7)*phihat(nls7:nus7);
    ...
    elseif jj<=nus2
        ...
        % Psibar
        psibarAux1(4:6) = - J(4:6,nls2:nus2)*phihat(nls2:nus2)-J(4:6,nls7:nus7)*phihat(nls7:nus7);
    ...
    elseif jj<=nus3
        ...
        % Psibar
    	psibarAux1(7:9) = - J(7:9,nls3:nus3)*phihat(nls3:nus3)-J(7:9,nls7:nus7)*phihat(nls7:nus7);
    ...
    elseif jj<=nus4
        ...
        % Psibar
        psibarAux1(10:12) = -J(10:12,nls4:nus4)*phihat(nls4:nus4)-J(10:12,nls7:nus7)*phihat(nls7:nus7);
    ...
    elseif jj<=nus5
        ...
        % Psibar
        psibarAux1(13:15) = -J(13:15,nls5:nus5)*phihat(nls5:nus5)-J(13:15,nls7:nus7)*phihat(nls7:nus7);
    ...
    elseif jj<=nus6
        ...
        % Psibar
    	psibarAux1(16:18) = -J(16:18,nls6:nus6)*phihat(nls6:nus6)-J(16:18,nls7:nus7)*phihat(nls7:nus7);
...
if fl==1
    ...
    if jj<=nus1
        ...
        % Psibar
        psibarAux2(1:3) = -dJ(1:3,nls1:nus1)*dq(nls1:nus1)-dJ(1:3,nls7+3:nus7)*dq(nls7+3:nus7);
        psibarAux1(1:3) = - J(1:3,nls1:nus1)*phihat(nls1:nus1)-J(1:3,nls7:nus7)*phihat(nls7:nus7);
    	psibar(1:3) = psibarAux1(1:3)+psibarAux2(1:3);
        %
        auxp1 = psibar(4:6)-auxa1*psibar(1:3);
    ...
    elseif jj<=nus2
        ...
        % Psibar
        psibarAux1(4:6) = - J(4:6,nls2:nus2)*phihat(nls2:nus2)-J(4:6,nls7:nus7)*phihat(nls7:nus7);
        psibarAux2(4:6) = -dJ(4:6,nls2:nus2)*dq(nls2:nus2)-dJ(4:6,nls7+3:nus7)*dq(nls7+3:nus7);
        psibar(4:6) = psibarAux1(4:6)+psibarAux2(4:6);
        %
        auxp1 = psibar(4:6)-auxa1*psibar(1:3);
        auxp2 = psibar(7:9)-auxa2*psibar(1:3)-auxb1*auxp1;
    ...
    elseif jj<=nus3
        ...
        psibarAux1(7:9) = - J(7:9,nls3:nus3)*phihat(nls3:nus3)-J(7:9,nls7:nus7)*phihat(nls7:nus7);
        psibarAux2(7:9) = -dJ(7:9,nls3:nus3)*dq(nls3:nus3)-dJ(7:9,nls7+3:nus7)*dq(nls7+3:nus7);
        psibar(7:9) = psibarAux1(7:9)+psibarAux2(7:9);
        %
        auxp2 = psibar(7:9)-auxa2*psibar(1:3)-auxb1*auxp1;
        auxp3 = psibar(10:12) -auxa3*psibar(1:3) - auxb2*auxp1 - auxc1*auxp2;
    ...
    elseif jj<=nus4
        ...
        psibarAux1(10:12) = -J(10:12,nls4:nus4)*phihat(nls4:nus4)-J(10:12,nls7:nus7)*phihat(nls7:nus7);
        psibarAux2(10:12) =-dJ(10:12,nls4:nus4)*dq(nls4:nus4)-dJ(10:12,nls7+3:nus7)*dq(nls7+3:nus7);
        psibar(10:12) = psibarAux1(10:12)+psibarAux2(10:12);
        %
    	auxp3 = psibar(10:12) -auxa3*psibar(1:3) - auxb2*auxp1 - auxc1*auxp2;
    	auxp4 = psibar(13:15) - auxa4*psibar(1:3) - auxb3*auxp1 - auxc2*auxp2 - auxd1*auxp3;
    ...
    elseif jj<=nus5
        ...
        psibarAux1(13:15) = -J(13:15,nls5:nus5)*phihat(nls5:nus5)-J(13:15,nls7:nus7)*phihat(nls7:nus7);
        psibarAux2(13:15) =-dJ(13:15,nls5:nus5)*dq(nls5:nus5)-dJ(13:15,nls7+3:nus7)*dq(nls7+3:nus7);
        psibar(13:15) = psibarAux1(13:15)+psibarAux2(13:15);
    	%
    	auxp4 = psibar(13:15) - auxa4*psibar(1:3) - auxb3*auxp1 - auxc2*auxp2 - auxd1*auxp3;
    	auxp5 = psibar(16:18) - auxa5*psibar(1:3) - auxb4*auxp1 - auxc3*auxp2 - auxd2*auxp3 -auxe1*auxp4;
    ...
    elseif jj<=nus6
        ...
        psibarAux1(16:18) = -J(16:18,nls6:nus6)*phihat(nls6:nus6)-J(16:18,nls7:nus7)*phihat(nls7:nus7);
        psibarAux2(16:18) =-dJ(16:18,nls6:nus6)*dq(nls6:nus6)-dJ(16:18,nls7+3:nus7)*dq(nls7+3:nus7);
        psibar(16:18) = psibarAux1(16:18)+psibarAux2(16:18);
        %
    	auxp5 = psibar(16:18) - auxa5*psibar(1:3) - auxb4*auxp1 - auxc3*auxp2 - auxd2*auxp3 -auxe1*auxp4;
    % sub-system 7
...
%qdd(nls1:nus1) = phihat(nls1:nus1)+ihatTr(nls1:nus1,1:15)*lam;
%qdd(nls2:nus2) = phihat(nls2:nus2)+ihatTr(nls2:nus2,1:15)*lam;
%qdd(nls3:nus3) = phihat(nls3:nus3)+ihatTr(nls3:nus3,1:15)*lam;
%qdd(nls4:nus4) = phihat(nls4:nus4)+ihatTr(nls4:nus4,1:15)*lam;
%qdd(nls5:nus5) = phihat(nls5:nus5)+ihatTr(nls5:nus5,1:15)*lam;
%qdd(nls6:nus6) = phihat(nls6:nus6)+ihatTr(nls6:nus6,1:15)*lam;
