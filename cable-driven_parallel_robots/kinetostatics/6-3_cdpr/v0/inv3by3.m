% RSSLM-CDPR-Kinetostatics inv3by3 module. A pre-computed symbolic expressions of the inverse of a non-singular matrix of dimension 3 by 3 is used for determining the matrix inverse.
