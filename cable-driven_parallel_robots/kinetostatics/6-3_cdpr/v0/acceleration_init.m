% RSSLM-CDPR-Kinetostatics acceleration_init module. The common portions in determining the changes in joint accelerations with perturbations in the joint positions and velocities are computed here. 
...
function [phihat, ihatTr, ibar, psibarAux1, psibarAux2, auxa, auxa1, auxa2, auxa3, auxa4, auxa5, auxb, auxb1, auxb2, auxb3, auxb4, auxc0, auxc, auxc1, auxc2, auxc3, auxd01, auxd02, auxd, auxd1, auxd2, auxe01, auxe02, auxe03, auxe, auxe1, auxf01, auxf02, auxf03, auxf04, auxp1, auxp2, auxp3, auxp4, auxp5] = acceleration_init(q, dq, tu, tau_d)
...
% Initialisation
phihat = zeros(nus7,1);
ihatTr = zeros(nus7,18);
ibar = zeros(18,18);
psibarAux1 = zeros(18,1);
psibarAux2 = zeros(18,1);
