% RSSLM-CDPR-Kinetostatics animate module. This module depicts the motion of the system under study.
...
% Function calls to data, initials, and for_kine.
...
% To record the evolution of the configurations of cables
